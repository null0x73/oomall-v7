...
public class Common {
    ...
    public static void setHttpStatusCodeAs201Created(HttpServletResponse response){
    ...
    public static void setHttpStatusCode(int httpStatusCode, HttpServletResponse response){
        response.setStatus(httpStatusCode);
    }



    public static Object generateBadReqeustReturnObject(HttpServletResponse response){
        response.setStatus(HttpStatus.BAD_REQUEST.value());
        Map<String,String> returnObject = new HashMap<>();
        returnObject.put("errno","503");
        returnObject.put("errmsg","请求参数不合法");
        return returnObject;
    }



    public static Object generateCustomizedErrorReturnObject(int httpStatusCode, int errno, String errmsg, HttpServletResponse response){
        response.setStatus(httpStatusCode);
        Map<String,Object> returnObject = new HashMap<>();
        returnObject.put("errno",errno);
        returnObject.put("errmsg",errmsg);
        return returnObject;
    }


    public static Object generateCustomizedErrorReturnObject(int httpStatusCode, ResponseCode responseCode, HttpServletResponse response){
        response.setStatus(httpStatusCode);
        Map<String,Object> returnObject = new HashMap<>();
        returnObject.put("errno",responseCode.getCode());
        returnObject.put("errmsg",responseCode.getMessage());
        return returnObject;
    }

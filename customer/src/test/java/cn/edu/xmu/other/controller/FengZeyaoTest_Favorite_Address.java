...
public class FengZeyaoTest_Favorite_Address {
    private static final Logger logger = LoggerFactory.getLogger(FengZeyaoTest_Favorite_Address.class);

    //@Value("${public-test.managementgate}")
    private String managementGate="127.0.0.1:8081";

    //@Value("${public-test.mallgate}")
    private String mallGate="127.0.0.1:8081";
    ...
    public void getFavorites1() throws Exception {
        ...
        String token=creatTestToken(26L,2L,100);

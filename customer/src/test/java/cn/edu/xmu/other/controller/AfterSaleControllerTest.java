...
public class AfterSaleControllerTest {
    ...
    public AfterSaleControllerTest(){
     ...
     */
    @Test
    public void adminSearchByIdTest2(){
        String token=creatTestToken(2l,0l,100);
     ...
     */
    @Test
    public void adminSearchByIdTest3(){
        String token=creatTestToken(2l,0l,100);

        byte[] ret2=this.manageClient.get().uri("/shops/1/aftersales/23333")
                .header("authorization", token)
                .exchange()
